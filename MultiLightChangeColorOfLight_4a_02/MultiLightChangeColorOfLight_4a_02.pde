...
void defineLight(int nb)
{
  ...
  for (int i=0; i<nb; i++)
  {
    float radiusX = random(150, 200);
    float radiusY = random(150, 200);
    float radiusZ = random(150, 200);   
    ...
    lightPos.add(new PtLight(new PVector(x, y, z), new PVector(random(255), random(255), random(255))));
  }
}
